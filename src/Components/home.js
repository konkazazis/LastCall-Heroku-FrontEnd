...
function Home({userInfo}) {
  ...
  return (
    <div className='animate__animated animate__fadeIn h-[100%] m-2'>
      <div className='flex h-2/4 mb-2'>
        <div className='bg-white mr-2 w-3/4 p-4'>
      ...
      <div className='flex h-2/4 content-between'>
